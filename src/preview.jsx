    ...
    return (
      <div className={classes}>
       <div className="survey_wrap">
          <div className="survey_pages_tab">
            <a className="pages_preview" href="javascript:;"><i></i></a>
            <div className="pages_wrap">
              <ul><li class="pages_item current" data-pid="1"> <span class="pages_show">第1页</span> <a class="pages_remove" href="javascript:;">×</a> </li></ul>
            <a class="pages_item pages_end"><span class="pages_show">结束页</span></a></div>
...
Preview.defaultProps = { showCorrectColumn: false, files: [], editMode: false, editElement: null, className: 'react-form-builder-preview pull-right'}
