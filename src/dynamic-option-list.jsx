    ...
    return (
      <div className="dynamic-option-list">
        <ul>
          <li>
            <div className="row">
              <div className="col-sm-6"><b>选项</b></div>
              <div className="col-sm-2"><b>值</b></div>
              <div className="col-sm-4"><b>是否正确</b></div>
            </div>
          </li>
          {
                ...
                <li className="clearfix" key={this_key}>
                  <div className="row">
                    <div className="col-sm-6">
                      <input tabIndex={index+1} className="form-control" style={{width: '100%'}} type="text" name={'text_'+index} placeholder="选项内容" value={option.text} onBlur={this.updateOption.bind(this)} onChange={this.editOption.bind(this, index)} />
                    </div>
